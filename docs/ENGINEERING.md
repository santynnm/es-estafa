# Bitácora técnica — "¿Es estafa?"

> Este es el registro de construcción día a día del proyecto, con el detalle completo de
> cada decisión de diseño, corrección de seguridad y verificación realizada. Si buscás
> una introducción general del proyecto (qué hace, stack, cómo correrlo), andá al
> [README principal](../README.md). Este documento es el complemento para quien quiera
> ver el razonamiento detrás de cada pieza — RLS, idempotencia, concurrencia, cuotas,
> accesibilidad — con el nivel de detalle de una auditoría, no de una presentación.
